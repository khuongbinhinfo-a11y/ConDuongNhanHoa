        ...
        <Container>
          <div className="mx-auto max-w-[1060px] space-y-8">
            <section className="rounded-[24px] border border-[var(--color-border)] bg-[var(--color-card)] p-6 shadow-[0_16px_34px_rgba(36,76,99,0.08)] lg:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.1em] text-[var(--color-teal)]">Giới thiệu nền tảng</p>
              <h1 className="mt-2 text-[clamp(1.9rem,3.6vw,3rem)] font-semibold text-[var(--color-text-strong)]">Thông Tin Lành Mạnh</h1>
            ...
            <section className="rounded-[24px] border border-[var(--color-border)] bg-[rgba(251,247,241,0.78)] p-6 lg:p-8">
              <h2 className="text-[1.28rem] font-semibold leading-[1.35] text-[var(--color-text-strong)]">Định hướng vận hành</h2>
            ...
            <section className="rounded-[24px] border border-[var(--color-border)] bg-[rgba(245,239,230,0.66)] p-6 lg:p-8">
              <h2 className="text-[1.28rem] font-semibold leading-[1.35] text-[var(--color-text-strong)]">Bắt đầu ở đâu?</h2>
              <p className="mt-2 max-w-[64ch] text-[0.98rem] text-[var(--color-text-muted)]">

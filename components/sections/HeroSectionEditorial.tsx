...
export function HeroSectionEditorial({ content }: HeroSectionEditorialProps) {
  return (
        <section className="hero-editorial relative overflow-hidden bg-[linear-gradient(180deg,rgba(252,254,251,0.92),rgba(248,252,248,0.64))] py-14 lg:py-20">
      <Container>
        <div className="grid items-center gap-9 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:gap-14">
          <div className="relative z-10 max-w-[620px]">
            <p className="hero-editorial__eyebrow mb-4 inline-flex rounded-full border border-[rgba(90,154,108,0.3)] bg-[var(--color-accent-light)] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.11em] text-[var(--color-navy)]">
              {content.eyebrow}
            </p>
            ...
            <div className="hero-editorial__cta-cluster mt-8 flex flex-wrap items-start gap-3.5 sm:items-center">
              <Button
                ...
                className="hero-editorial__cta rounded-[14px] border border-[rgba(90,154,108,0.3)] px-5 py-3 text-[0.88rem] tracking-[0.01em] shadow-[0_8px_20px_rgba(90,154,108,0.18)] hover:shadow-[0_12px_24px_rgba(90,154,108,0.24)]"
              >
              ...
              {content.secondaryCtaLabel && content.secondaryCtaHref ? (
                <Button
                  ...
                  variant="ghost"
                  className="rounded-[12px] border-[var(--color-border)] bg-[rgba(251,253,251,0.88)] px-4 py-2.5 text-[0.8rem] font-semibold shadow-none"
                >
          ...
          <div className="hero-editorial__media-shell relative isolate rounded-[26px] border border-[var(--color-border)] bg-[rgba(251,253,251,0.9)] p-[0.62rem] shadow-[0_12px_32px_rgba(90,154,108,0.1)]">
            <div className="absolute -right-11 -top-10 -z-10 h-44 w-44 rounded-full bg-[rgba(125,187,146,0.15)] blur-2xl" />

...
export type FeaturedPathI18nItem = {
  title: string;
  description: string;
  href: string;
  ctaLabel: string;
...
export type FeaturedPathsI18nContent = {
  eyebrow?: string;
  title: string;
  subtitle: string;
  featuredTagLabel: string;
  cards: FeaturedPathI18nItem[];
};

type FeaturedPathsSectionI18nProps = {
  content: FeaturedPathsI18nContent;
};

export function FeaturedPathsSectionI18n({ content }: FeaturedPathsSectionI18nProps) {
        ...
        <div className="rounded-[26px] border border-[var(--color-border)] bg-[linear-gradient(160deg,rgba(252,250,246,0.88),rgba(220,232,221,0.55),rgba(252,250,246,0.9))] p-6 shadow-[0_16px_30px_rgba(31,65,88,0.07)] lg:p-8">
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-12">
            {featuredCard ? (
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.1em] text-[rgba(245,239,230,0.8)]">
                  {content.featuredTagLabel}
                </p>

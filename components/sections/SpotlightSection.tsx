...
export function SpotlightSection({ title, description, topics, ctaLabel, ctaHref }: SpotlightSectionProps) {
  return (
    <section className="py-10 lg:py-14">
      <Container>
        <div className="mx-auto max-w-[860px] overflow-hidden rounded-[24px] border border-[var(--color-border)] bg-[linear-gradient(155deg,rgba(255,253,253,0.98),rgba(233,183,195,0.14),rgba(191,221,226,0.18))] p-6 shadow-[0_14px_30px_rgba(223,166,184,0.14)] lg:p-8">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            {topics.map((topic, i) => (
              <div
                key={i}
                className="flex items-start gap-3 rounded-[14px] border border-[var(--color-border)] bg-[rgba(255,253,253,0.85)] p-3.5"
              >
